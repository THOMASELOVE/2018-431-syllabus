...
TA office hours will start on Tuesday, September 4, and we'll specify further details as soon as possible.

# Software

The course makes heavy use of the R statistical programming language. Details on downloading and installing R and the development environment, R Studio, for either PC or Mac, are available at https://github.com/THOMASELOVE/431-2018/tree/master/software
...
**Complete instructions, with a step-by-step walkthrough, are available at https://github.com/THOMASELOVE/431-2018/tree/master/software**
...
1. Download and install the latest version of R (version 3.5.1 as of this writing) at http://cran.case.edu/ or https://cran.r-project.org/.
2. Download and install R Studio (version 1.1.456 or later) at https://www.rstudio.com/products/rstudio/download/#download.
3. Install some R packages - an R "package" is a collection of functions, data, and documentation that extends the capabilities of R, and is the critical way to get R doing interesting work. To install the packages for our course, follow the instructions at https://github.com/THOMASELOVE/431-2018/blob/master/software/packages.md
...
The main text is a set of Notes for the course, maintained by Dr. Love at https://thomaselove.github.io/2018-431-notes/. 
